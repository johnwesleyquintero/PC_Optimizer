...
a = Analysis(
    ...
    hiddenimports=['tkinter', 'PIL', 'src.core.performance_optimizer', 'src.core.sentinel_core', 'src.core.config_manager', 'src.core.environment_manager', 'src.core.monitoring_manager', 'src.core.logging_manager'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
