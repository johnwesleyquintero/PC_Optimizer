...
:: 2. Format code (Black) -> Logs to run_tasks.log
:: 3. Check code style (Flake8) -> Logs to run_tasks.log
...
ECHO.
ECHO [2/5] Formatting code with Black (logging to %LOGFILE%)...
...
ECHO.
ECHO [3/5] Checking code style with Flake8 (logging to %LOGFILE%)...
